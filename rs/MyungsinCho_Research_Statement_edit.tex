...
\draw[seq]   (global) --  node[above,font=\scriptsize] {$\kappa_F$}  (local);
...
\node[main] (Ifiber) at (-5.2,-1)   
	{$I_{\mathbb Z_2} \bigl(\Sigma\Fib(\kappa_F)\bigr)$};
...
\draw[seq] (Ilocal) --  node[above,font=\scriptsize] {$I_{\bZ_2}\kappa_F$} (Iglobal);
