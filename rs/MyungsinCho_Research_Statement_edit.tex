...
Many fundamental questions in arithmetic have a local-to-global form. One seeks to recover global information from simpler local data and to understand why seemingly different invariants are related by duality. Descent provides a mechanism for such reconstruction, while duality reveals complementary structures within the resulting information. My research asks how these two principles extend from arithmetic into stable homotopy theory. The central goal of my research program is to understand the duality phenomena and descent behavior of \emph{Real algebraic K-theory}.

Algebraic K-theory organizes arithmetic and algebraic information into a spectrum, allowing relationships that are difficult to see at the level of individual groups to be studied homotopically. Real algebraic K-theory enriches this construction by retaining information about duality and symmetry. Its underlying nonequivariant theory is ordinary algebraic K-theory, while its fixed-point theory recovers Grothendieck--Witt theory, which studies symmetric and quadratic forms. It therefore provides a natural setting in which to ask whether descent and duality can be understood simultaneously across algebraic K-theory and the theory of forms. Such a framework would offer both structural explanations and new methods for computing these theories.

My work approaches this long-term problem from several complementary directions. My dissertation establishes a K-theoretic form of arithmetic duality at the prime \(2\), completing a case in which real embeddings introduce phenomena absent at odd primes. This gives the first nonequivariant step toward understanding duality in the Real setting. My current work studies the corresponding question for Grothendieck--Witt theory, the fixed-point side of Real algebraic K-theory. In parallel, my collaborative work on Real trace methods develops tools for approximating and computing equivariant invariants that are otherwise difficult to access directly. My research on transfer systems and equivariant algebra investigates the algebraic structures needed to organize operations in genuine equivariant homotopy theory. Together, these projects form a broader program to understand how arithmetic duality, descent, and equivariant structure interact in Real algebraic K-theory.

\section{Background}

Stable homotopy theory provides a setting in which algebraic invariants are organized into \emph{spectra}. A spectrum contains a sequence of homotopy groups together with the maps and operations that connect them, allowing one to study the structure relating different invariants rather than treating each group separately. Algebraic K-theory applies this perspective to rings and categories. To a ring \(R\), it assigns a spectrum \(K(R)\) whose homotopy groups encode information about projective modules, their automorphisms, and higher relations among them. These groups contain important arithmetic information, but they are often extremely difficult to compute directly.

One way to make algebraic K-theory more accessible is through \emph{descent}. Rather than studying a global object all at once, descent attempts to reconstruct it from data over simpler local pieces. For arithmetic rings, the Thomason descent spectral sequence connects algebraic K-theory to étale cohomology, whose local-to-global behavior is much better understood. At a prime \(p\), \(K(1)\)-localization isolates the first periodic layer of algebraic K-theory, where this connection becomes especially effective. Descent therefore serves both as a computational tool and as a bridge between stable homotopy theory and arithmetic geometry.

Arithmetic cohomology also satisfies powerful duality theorems. Tate--Poitou duality, for example, relates the global cohomology of a number field to cohomological information coming from its completions. Through the descent spectral sequence, such arithmetic dualities suggest corresponding duality phenomena in algebraic K-theory. In this homotopical formulation, one expects the failure of a global-to-local map in K-theory to be described by a dual of the original K-theory spectrum. My dissertation proves such a statement at the prime \(2\), where real embeddings create additional complications that do not appear at odd primes.

Real algebraic K-theory places this arithmetic picture in an equivariant setting. A ring equipped with an anti-involution has not only modules and automorphisms, but also dual modules and symmetric forms. Real algebraic K-theory packages these structures into a genuine \(C_2\)-equivariant spectrum \cite{HMreal}. Forgetting the \(C_2\)-action recovers ordinary algebraic K-theory, while taking fixed points recovers Grothendieck--Witt theory. Thus, a descent theory for Real algebraic K-theory should simultaneously account for ordinary K-theory, the arithmetic of symmetric forms, and the equivariant structure relating them.

This leads to the guiding problem of my research: can global Real algebraic K-theory be reconstructed from local or étale information, and how does this reconstruction interact with duality? Addressing this problem requires more than extending nonequivariant arguments formally. Fixed points, transfers, norms, and representation-graded homotopy groups introduce new structures that must remain compatible throughout the descent process. The following sections describe my progress toward this goal, beginning with arithmetic duality in ordinary algebraic K-theory and continuing with Grothendieck--Witt duality, Real trace methods, and the algebraic foundations of equivariant homotopy theory.
