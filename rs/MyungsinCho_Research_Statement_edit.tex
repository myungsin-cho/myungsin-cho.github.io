...
%첫문장이 너무 heavy하다. 바로 읽기 싫어질거 같은데
...
Blumberg and Mandell proved a stronger spectrum-level duality at every odd prime using Anderson duality $I_{\bZ_p}$, a spectral refinement of Pontrjagin duality for abelian groups \cite{MR4121155}. % Anderson duality라는 도구를 이용한게 아니고, Anderson duality라는 언어로 formulate했다는 뉘앙스가 들어갔으면 좋겠다.
%local duality도 증명했다는 말을 넣고싶은데 이러면 너무 늘어질거 같긴 하다.
...
The completion sequence of $K(1)$-local algebraic K-theory admits a canonical \(2\)-adic Anderson self-duality.
...
%이렇게 밋밋하게 설명하지 말고, 증명의 핵심 아이디어로써 설명하자.
\begin{figure}[h]
\centering
